...
正式 `m2_v7_clean_init0` 随后由 watchdog 启动。iteration 0 完成 96 局 / 1,709 decisions：0 engine error、0 visibility violation，KL 0.00354，4 epochs，grad norm 0.996→0.460，reward 未反转，耗时 22.1 秒。长跑限制在 Act 1，未经三次 gate 与 450-seed audit 不会自动进入 full A0。
