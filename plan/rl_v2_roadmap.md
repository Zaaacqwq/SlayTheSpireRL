...
归档 v1；清空旧 RL；固定并构建 CLI；冻结 schema；五角色各随机合法运行至少 20 局；确定性重放；1/4/8/16 worker 吞吐、内存、稳定性和恢复测试。8 workers ≥100 decision steps/s、崩溃率 <0.1%、非法动作率 0。
